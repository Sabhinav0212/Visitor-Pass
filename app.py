...
cluster = MongoClient("mongodb+srv://visitor:pass@visitorpass.d4220.mongodb.net/visitor?retryWrites=true&w=majority")
db = cluster["visitor"]
collection = db["users"]
    ...
    while True:
        ...
        if success:
            ...
            if (capture):
                ...
                cv2.imwrite(p, frame)
                #data = extract_card_details(r'C:\Users\hp\Desktop\pythonproj\pic4.jpeg')
...
def pan_read_data(text):
    ...
    if pan_type == 'newpan':
        ...
        while x < len(text0):
            ...
            #if -1 not in {text0[x].find("Account"),text0[x].find("Number"),text0[x].find("Card")}:
                if text0[x + 1] != '':
                    pan = text0[x + 1]
                else:
                    pan = text0[x + 2]
...
def extract_card_details(filename):
    ...
    #filename = 'C:/Users/hp/Desktop/pythonproj/pic6.jpg'
